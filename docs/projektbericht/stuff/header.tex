%%%%%%%%%%%%%%%%%%%  Document info  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projname}{Projektbericht Moderne Softwarearchitekturen}
\newcommand{\titel}{TeamBoard}
\newcommand{\untertitel}{Eine Microservice-Plattform zur Team-Kollaboration}
\newcommand{\thesisname}{Projektbericht}
\newcommand{\Datum}{\today}
\newcommand{\authorname}{Maximilian Cwik, Henry Müller, Jan Soetebeer}
%%%%%%%%%%%%%%%%%%%  Document info  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{makecell}
\usepackage{array}
% varioref wird weiter unten nach babel geladen (Reihenfolge zwingend,
% sonst Endlosrekursion in \extras<sprache>).
...
%%%%%%%%%%%%%%%%%%%  Platzhalter-Hilfen fuer den Bericht  %%%%%%%%%%%%%%%%%%
% Rahmen-Box als Platzhalter fuer noch zu erstellende Abbildungen oder Plots.
% #1 Hoehe (z.B. 6cm), #2 Bildunterschrift, #3 Label
\newcommand{\platzhalterabb}[3]{%
  \begin{figure}[ht]
    \centering
    \setlength{\fboxsep}{0pt}%
    \fbox{\begin{minipage}[c][#1][c]{0.92\linewidth}%
      \centering\itshape\color{codegray} Platzhalter: #2
    \end{minipage}}%
    \caption{#2}%
    \label{#3}%
  \end{figure}%
...
\usepackage[main=ngerman,english]{babel} % english mitgeladen, damit varioref
                                         % seine \extrasenglish-Strings anhängen kann
\usepackage[ngerman]{varioref} % muss nach babel geladen werden
...
\usepackage{multirow}
% quotchap entfernt: erzeugte grosse, rechtsbuendige Kapitelnummern.
% Stattdessen kompakte KOMA-Kapitelkoepfe, nur wenig groesser als \section,
% ohne grosse Nummer und linksbuendig.
\setkomafont{chapter}{\LARGE\bfseries}
\RedeclareSectionCommand[
    beforeskip=-.5\baselineskip,
    afterskip=.6\baselineskip
]{chapter}
