...
Neue Boardtypen sollen ergänzbar sein, **ohne** Änderungen an Task-, Document- oder anderen Services
(„Plugin-Pattern aus der Aufgabenstellung"). In der ursprünglichen Umsetzung waren Boardtypen jedoch
