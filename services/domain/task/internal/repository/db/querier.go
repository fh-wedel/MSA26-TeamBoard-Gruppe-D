...
type Querier interface {
	...
	UpdateTask(ctx context.Context, id uuid.UUID, title, description, priority *string, dueDateSet bool, dueDate *time.Time, startDateSet bool, startDate *time.Time, labels []string, status *string) (*Task, error)
